...
public class AFKLast implements SortingRule {
	...
	public int compare(Context context, IPlayer player1, IPlayer player2) {
		boolean player1AFK = ((TLPlayer) player1).getOpt(BukkitData.Essentials_IsAFK).orElse(false);
		boolean player2AFK = ((TLPlayer) player2).getOpt(BukkitData.Essentials_IsAFK).orElse(false);
