...
public class ExpressionTokenizer {
	...
	private static final ImmutableMap<String, Token> tokens3 = ImmutableMap.<String, Token>builder().put("all", BooleanToken.TRUE).put("and", Token.AND).build();
	private static final ImmutableMap<String, Token> tokens2 = ImmutableMap.<String, Token>builder().put("&&", Token.AND).put("||", Token.OR).put("or", Token.OR).put("==", Token.EQUAL).put("!=", Token.NOT_EQUAL).put(">=", Token.GREATER_OR_EQUAL_THAN).put("<=", Token.LESSER_OR_EQUAL_THAN).build();
	private static final ImmutableMap<String, Token> tokens1 = ImmutableMap.<String, Token>builder().put("(", Token.OPENING_PARENTHESIS).put(")", Token.CLOSING_PARENTHESIS).put("!", Token.NEGATION).put(">", Token.GREATER_THAN).put("<", Token.LESSER_THAN).put("=", Token.EQUAL).put(".", Token.CONCAT_STRING).build();
