...
public class BTLPDataTypes {
	...
	public static final TypeAdapterRegistry REGISTRY = new TypeAdapterRegistry(ImmutableMap.of(ICON, new TypeAdapter<Icon>() {
		@Override
		public Icon read(DataInput input) throws IOException {
			...
			return new Icon(uuid, Collections.singletonList(new GameProfile.Property("textures", value, signature)));
		}
		...
		public void write(DataOutput output, Icon icon) throws IOException {
			...
			for(GameProfile.Property property : icon.getProperties()) {
